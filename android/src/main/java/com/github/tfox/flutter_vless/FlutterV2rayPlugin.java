...
import com.github.tfox.flutter_vless.v2ray.V2rayController;
import com.github.tfox.flutter_vless.v2ray.V2rayReceiver;
...
public class FlutterV2rayPlugin implements FlutterPlugin, ActivityAware, PluginRegistry.ActivityResultListener {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        vpnControlMethod = new MethodChannel(binding.getBinaryMessenger(), "flutter_vless");
        vpnStatusEvent = new EventChannel(binding.getBinaryMessenger(), "flutter_vless/status");
