...
- Поставка 3.3: исправления остаются в нерелизной версии root/Android/podspec 1.1.6 и исходной версии platform_interface 1.1.2. Нативные версии не изменены, поскольку закреплённые артефакты уже поддерживают нужную авторизацию.
