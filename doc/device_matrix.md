...
The September 2026 local test suite uses controlled simulator/emulator peers and
keeps the development computer's VPN enabled. Those tests do not establish the
